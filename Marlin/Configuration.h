...
#define STRING_CONFIG_H_AUTHOR "(Galethor, Ender-3 Pro)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -51, -12, -1.85 }
 ...
 *   The result is a single tilted plane. Best for a flat bed.ED_LEVELING
 *
