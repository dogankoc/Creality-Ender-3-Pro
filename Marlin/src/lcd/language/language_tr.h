...
namespace Language_tr {
  ...
  LSTR MSG_FILAMENT_DIAM                  = _UxGT("Filament Çapı");
  LSTR MSG_FILAMENT_DIAM_E                = _UxGT("Filament Çapı *");
  ...
  LSTR MSG_FILAMENTCHANGE                 = _UxGT("Filament Değiştir");
  LSTR MSG_FILAMENTCHANGE_E               = _UxGT("Filament Değiştir *");
  LSTR MSG_FILAMENTLOAD                   = _UxGT("Filament Yükle");
  LSTR MSG_FILAMENTLOAD_E                 = _UxGT("Filament Yükle *");
  LSTR MSG_FILAMENTUNLOAD                 = _UxGT("Filament Çıkart");
  LSTR MSG_FILAMENTUNLOAD_E               = _UxGT("Filament Çıkart *");
  ...
  LSTR MSG_KILL_EXPECTED_PRINTER          = _UxGT("Yanlış Yazıcı");
    ...
    LSTR MSG_INFO_PRINT_FILAMENT          = _UxGT("Toplam Filament");
  #else
  ...
  LSTR MSG_FILAMENT_CHANGE_HEADER         = _UxGT("Filament DEGISTIR");
  LSTR MSG_FILAMENT_CHANGE_HEADER_PAUSE   = _UxGT("BASKI DURAKLATILDI");
  LSTR MSG_FILAMENT_CHANGE_HEADER_LOAD    = _UxGT("Filament YüKLE");
  LSTR MSG_FILAMENT_CHANGE_HEADER_UNLOAD  = _UxGT("Filament ÇIKART");
  ...
  LSTR MSG_MMU2_CHOOSE_FILAMENT_HEADER    = _UxGT("Filament SEÇ");
  ...
  LSTR MSG_MMU2_LOAD_FILAMENT             = _UxGT("Filament Yükle");
  LSTR MSG_MMU2_LOAD_ALL                  = _UxGT("Tümünü Yükle");
  LSTR MSG_MMU2_LOAD_TO_NOZZLE            = _UxGT("Nozula Yükle");
  LSTR MSG_MMU2_EJECT_FILAMENT            = _UxGT("Filament Çıkart");
  LSTR MSG_MMU2_EJECT_FILAMENT_N          = _UxGT("Filament Çıkart ~");
  ...
  //
    ...
    LSTR MSG_FILAMENT_CHANGE_INIT         = _UxGT(MSG_3_LINE("Filament değişimi", "için başlama", "bekleniyor"));
    LSTR MSG_FILAMENT_CHANGE_INSERT       = _UxGT(MSG_3_LINE("Filamentı yükle", "ve devam için", "tuşa bas..."));
    ...
    LSTR MSG_FILAMENT_CHANGE_UNLOAD       = _UxGT(MSG_2_LINE("Filamentın çıkması", "bekleniyor"));
    LSTR MSG_FILAMENT_CHANGE_LOAD         = _UxGT(MSG_2_LINE("Filamentın yüklenmesi", "bekleniyor.."));
    LSTR MSG_FILAMENT_CHANGE_PURGE        = _UxGT(MSG_2_LINE("Filament Temizlemesi", "için bekle"));
    LSTR MSG_FILAMENT_CHANGE_CONT_PURGE   = _UxGT(MSG_2_LINE("Filament Temizlemesi", "bitirmek için tıkla"));
